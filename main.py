...
class Levels:
    ...
    def StageTwo(self):
        screen.blit(self.bg, (0, 0))
        # Refer to Blueprint for block assignment
        block1 = pygame.Rect(500, 450, 50, 50)
    ...
    def StageThree(self):
        ...
        block2 = pygame.Rect(200, 450, 100, 50)
        block3 = pygame.Rect(0, 450, 50, 50)
        block4 = pygame.Rect(600, 350, 50, 50)
        block5 = pygame.Rect(450, 150, 50, 50)
        block6 = pygame.Rect(300, 150, 50, 50)
        block7 = pygame.Rect(50, 150, 150, 50)
        block8 = pygame.Rect(200, 0, 250, 50)
        # Drawing Course
        pygame.draw.rect(screen, "black", block1)
        pygame.draw.rect(screen, "black", block2)
        pygame.draw.rect(screen, "black", block3)
    ...
    def StageFour(self):
        ...
        screen.blit(self.bg, (0, 0))
        # Initializing Course
        block1 = pygame.Rect(200, 450, 250, 50)
        block2 = pygame.Rect(550, 300, 150, 50)
        block3 = pygame.Rect(100, 250, 300, 50)
    ...
    def StageFive(self):
        ...
        screen.blit(self.bg, (0, 0))
        # Initializing Course
        block1 = pygame.Rect(0, 300, 50, 50)
        block2 = pygame.Rect(150, 100, 50, 50)
        # Drawing Course
        pygame.draw.rect(screen, "black", block1)
        pygame.draw.rect(screen, "black", block2)
    ...
    def StageSix(self):
        ...
        screen.blit(self.bg, (0, 0))
        # Initializing Course
        block1 = pygame.Rect(0, 400, 50, 50)
        block2 = pygame.Rect(250, 350, 50, 50)
        block3 = pygame.Rect(550, 300, 50, 50)
        block4 = pygame.Rect(250, 150, 50, 50)
        block5 = pygame.Rect(0, 50, 50, 50)
        # Drawing Course
        pygame.draw.rect(screen, "black", block1)
        pygame.draw.rect(screen, "black", block2)
        pygame.draw.rect(screen, "black", block3)
    ...
    def switchLevel(self):
        # Progression
        if self.nxt_lvl[-1] == 'beg' and self.player.rect.centery < 0:
            # Modifying
        ...
        elif self.nxt_lvl[-1] == '1' and self.player.rect.centery < 0:
            # Modifying
            self.player.rect.bottom = 500
            self.bg = pygame.image.load("images/nightSKy.jpg").convert_alpha()
            # Levels
        ...
        elif self.nxt_lvl[-1] == '2' and self.player.rect.centery < 0:
            # Modifying
            self.player.rect.bottom = 500
            self.bg = pygame.image.load("images/nightSKy.jpg").convert_alpha()
            # Levels
        ...
        elif self.nxt_lvl[-1] == '3' and self.player.rect.centery < 0:
            # Modifying
            self.player.rect.bottom = 500
            self.bg = pygame.image.load("images/nightSKy.jpg").convert_alpha()
            # Levels
        ...
        elif self.nxt_lvl[-1] == '4' and self.player.rect.centery < 0:
            # Modifying
            self.player.rect.bottom = 500
            self.bg = pygame.image.load("images/nightSKy.jpg").convert_alpha()
            # Levels
        ...
        elif self.nxt_lvl[-1] == '5' and self.player.rect.centery < 0:
            # Modifying
            self.player.rect.bottom = 500
            self.bg = pygame.image.load("images/nightSKy.jpg").convert_alpha()
            # Levels
        ...
        # Regression
        elif self.nxt_lvl[-1] == '1' and self.player.rect.centery > 500:
            # Modifying
        ...
        elif self.nxt_lvl[-1] == '2' and self.player.rect.centery > 500:
            # Modifying
            self.player.rect.top = 0
            self.bg = pygame.image.load("images/nightSKy.jpg").convert_alpha()
            # Levels
        ...
        elif self.nxt_lvl[-1] == '3' and self.player.rect.centery > 500:
            # Modifying
            self.player.rect.top = 0
            self.bg = pygame.image.load("images/nightSKy.jpg").convert_alpha()
            # Levels
        ...
        elif self.nxt_lvl[-1] == '4' and self.player.rect.centery > 500:
            # Modifying
            self.player.rect.top = 0
            self.bg = pygame.image.load("images/nightSKy.jpg").convert_alpha()
            # Levels
        ...
        elif self.nxt_lvl[-1] == '5' and self.player.rect.centery > 500:
            # Modifying
            self.player.rect.top = 0
            self.bg = pygame.image.load("images/nightSKy.jpg").convert_alpha()
            # Levels
        ...
        elif self.nxt_lvl[-1] == '6' and self.player.rect.centery > 500:
            # Modifying
            self.player.rect.top = 0
            self.bg = pygame.image.load("images/nightSKy.jpg").convert_alpha()
            # Levels
